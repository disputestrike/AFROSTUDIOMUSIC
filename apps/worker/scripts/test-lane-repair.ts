...
assert(clean.soundBriefAddendum === '', 'clean plan has empty steering addendum');
...
assert(plan.soundBriefAddendum.includes('LANE REPAIR') && plan.soundBriefAddendum.includes('amapiano'), 'steering addendum is populated');
