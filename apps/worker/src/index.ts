...
import { processNightlyCompound, processMeasureBackfill, processLearnBackfill, processMineLexicon, processLexiconResearch, processWiktionaryHarvest, processGlossPass } from './processors/compound';
