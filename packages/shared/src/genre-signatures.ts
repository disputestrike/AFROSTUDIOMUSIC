...
export const GENRE_SIGNATURES: Record<string, GenreSignature> = {
  ...
  amapiano: { durationS: 200, bpm: 112, languages: ['zu', 'en'], tags: ['jazzy sustained piano chords', 'soulful amapiano keys', 'log drum bassline', 'airy shakers'], melodyPrompt: 'soulful jazzy amapiano piano chords, warm rhodes and sustained keys locking to the log-drum groove, no drums', kitRoles: FULL, fillBars: 16 },
