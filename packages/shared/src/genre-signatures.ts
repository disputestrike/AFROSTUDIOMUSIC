...
export const GENRE_SIGNATURES: Record<string, GenreSignature> = {
  ...
  hip_hop: { bpm: 92, languages: ['en'], tags: ['808 sub bass', 'crisp hat rolls', 'sparse dark keys or strings'], melodyPrompt: 'sparse dark piano or string motif with space for the vocal, boom-bap-to-modern color, no drums', kitRoles: CORE, fillBars: 8 },
  ...
  drill: { bpm: 142, languages: ['en'], tags: ['sliding 808 bass', 'dark bell and string motif', 'skittering hat slides'], melodyPrompt: 'dark bells and tense string motif, uk/ny drill mood, minor and menacing, no drums', kitRoles: CORE, fillBars: 8 },
  trap: { bpm: 140, languages: ['en'], tags: ['gliding 808 sub', 'triplet hi-hat rolls', 'eerie bell or pluck lead'], melodyPrompt: 'eerie bells and plucks with wide space, modern trap color, no drums', kitRoles: CORE, fillBars: 8 },
